...
<div>
	...
	<div>
		<form action="<%=ORSView.COLLEGE_LIST_CTL%>" method="post">
			...
			%>
			<center>
					<h1 class=" font-weight-bold pt-3"><u>College List</u></h1>
				</center>
<div class="row">
			...
			<div style="margin-bottom: 20px;" class="table-responsive">
				<table class="table table-striped table-hover table-bordered">
					...
					<tbody>
						...
						<div class="input-group">	<td align="center"><a href="CollegeCtl?id=<%=dto.getId()%>"style="color: black;> <i class="fas fa-edit" grey-text" style="font-size: 1rem;">Edit</a></i> </div></td>
						</tr>
					</tbody>
					<%
						}
