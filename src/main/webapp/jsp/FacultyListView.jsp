...
<div>
	...
	<div>
		<form action="<%=ORSView.FACULTY_LIST_CTL%>" method="post">
			...
			%>
			<center>
				<h1 class=" font-weight-bold pt-3"><U>Faculty
					List</U></h1>
			</center>
			</br>
			<div class="row">
				...
				<table class="table table-striped table-hover table-bordered">
					...
					<tbody>
						<tr style="font-weight: bold;">
							...
							<td align="center"><%=DataUtility.getDateString(dto.getDateofjoining())%></td>


							<td align="center"><%=dto.getCollegename()%></td>
							<td align="center"><%=dto.getCoursename()%></td>
							<td align="center"><%=dto.getSubjectname()%></td>
							<div class="input-group"> <td align="center"><a href="FacultyCtl?id=<%=dto.getId()%>"style="color: black;><i class="fas fa-edit" grey-text" style="font-size: 1rem;">Edit</a></i></td>
						</tr>
					</tbody>
					<%
						}
