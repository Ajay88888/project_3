...
<%@page import="in.co.rays.project3.model.CollegeModelInt"%>
				...
				<table class="table table-striped table-hover table-bordered">
					...
					<tbody>
						<tr style="font-weight: bold;">
							...
							<div class="input-group"><td align="center"><a href="StudentCtl?id=<%=dto.getId()%>"style="color: black;><i class="fas fa-edit" grey-text" style="font-size: 1rem;">Edit</a></i> </div></td>
						</tr>
					</tbody>
					<%
						}
